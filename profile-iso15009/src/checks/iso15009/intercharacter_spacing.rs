...
use crate::checks::iso15009::{find_stem_width, x_height_intersections};

use super::pair_kerning;

#[check(
    id = "iso15009/intercharacter_spacing",
    rationale = "
        
        According to ISO 15009, fonts used for in-car displays should not
        ...
        * diagonal characters should not touch (e.g. \"vv\").
        ...
        (Note that passing this check does not guarantee compliance with ISO-15009.)
